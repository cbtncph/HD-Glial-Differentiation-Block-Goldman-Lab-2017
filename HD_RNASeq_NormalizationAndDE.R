...
# HD_RNASeq_NormalizationAndDE.R
# For publication by Osipovitch et al. 2017 on Huntington's disease (HD)-derived glia
...
experiment_title = "HD OPC Differentiation Block - Genea hESC RNA-Seq"

### read counts and sample data sheet
countData_allSamples  <- read.table("countData_GeneaHD.txt", header = TRUE, sep = "\t", row.names = 1)
sampleData_allSamples <- read.table("sampleData_GeneaHD.txt", header = TRUE, sep = "\t", row.names = 1)
...
degs_001_17vsCTR <- read.table("Output - HD17 vs CTR/Output - DE Second Pass/DEGs_INTs/DEGs_001 - W_1.txt", sep = "\t")
degs_001_18vsCTR <- read.table("Output - HD18 vs CTR/Output - DE Second Pass/DEGs_INTs/DEGs_001 - W_1.txt", sep = "\t")
degs_001_20vsCTR <- read.table("Output - HD20 vs CTR/Output - DE Second Pass/DEGs_INTs/DEGs_001 - W_1.txt", sep = "\t")
degs_001_20vs19  <- read.table("Output - HD20 vs CTR19/Output - DE Second Pass/DEGs_INTs/DEGs_001 - W_1.txt", sep = "\t")
